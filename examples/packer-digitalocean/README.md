# Build a Droplet image with Packer & Mondoo
...
==> digitalocean: Executing Mondoo: [mondoo scan]
  ...
  →  report is available at https://mondoo.app/v/serene-dhawan-599345/focused-darwin-833545/reports/abcdefg123456789
...
**How can I discover droplet image ids?**

Just run:

```
curl -X GET --silent "https://api.digitalocean.com/v2/images?per_page=999" -H "Authorization: Bearer $DIGITALOCEAN_TOKEN" | jq
```
